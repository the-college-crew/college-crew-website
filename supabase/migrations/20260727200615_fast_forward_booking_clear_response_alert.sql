-- Superseded by 20260727200710; retained verbatim as production history.
...
begin
  ...
  update public.bookings set scheduled_at = v_now, response_alert_at = null where id = p_booking_id;
