/**
 * US states + DC. Used by the address fieldset's pick-or-type control (a
 * datalist) and by server-side signup validation. US-only for the pilot.
 */
...
/** Two-letter uppercase code if the input is a valid state code or name, else null. */
